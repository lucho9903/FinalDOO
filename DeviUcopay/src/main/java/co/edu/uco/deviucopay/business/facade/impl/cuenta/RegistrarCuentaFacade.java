...
public class RegistrarCuentaFacade implements FacadeWithoutReturn<CuentaDTO>{
    ...
    public void excute(final CuentaDTO dto) {
        ...
        try {
            ...
            // Confirmar la transacción después de una ejecución exitosa
            ...
            daoFactory.cancelarTransaccion();
            var mensajeUsuario = "Se ha presentado un problema tratando de registrar la informacion de la cuenta";
            var mensajeTecnico = "Se ha presentado un problema INESPERADO tratando de registrar la informacion de la cuenta";
